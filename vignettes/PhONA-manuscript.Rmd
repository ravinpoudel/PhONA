...
PhONA(physeqobj = ng_endo, cordata = ng_endo_sparcc.cor,
      pdata = ng_endo_sparcc.pval, model = "lasso",
      iters = 2, defineTreatment = "Nongraft",nodesize = 5,
...
PhONA(physeqobj = sg_endo, cordata = sg_endo_sparcc.cor,
      pdata = sg_endo_sparcc.pval, model = "lasso",
      iters = 2, defineTreatment = "Selfgraft",nodesize = 5,
...
PhONA(physeqobj = rst_endo, cordata = rst_endo_sparcc.cor,
      pdata = rst_endo_sparcc.pval, model = "lasso",
      iters = 2, defineTreatment = "RST-04-106",nodesize = 5,
...
PhONA(physeqobj = maxi_endo, cordata = maxi_endo_sparcc.cor,
      pdata = maxi_endo_sparcc.pval, model = "lasso",
      iters = 2, defineTreatment = "Maxifort",nodesize = 5,
...
PhONA(physeqobj = ng_rhizo, cordata = ng_rhizo_sparcc.cor,
...
PhONA(physeqobj = sg_rhizo, cordata = sg_rhizo_sparcc.cor,
      pdata = sg_rhizo_sparcc.pval, model = "lasso",
      iters = 5, defineTreatment = "Selfgraft",nodesize = 5,
      PhenoNodesize = 12, definePhenotype = "Marketable", PhenoNodelabel = "Selfgraft")
...
PhONA(physeqobj = rst_rhizo, cordata = rst_rhizo_sparcc.cor,
...
PhONA(physeqobj = maxi_rhizo, cordata = maxi_rhizo_sparcc.cor,
      pdata = maxi_rhizo_sparcc.pval, model = "lasso",
      defineTreatment = "Maxifort",nodesize = 5,
      iters = 2, PhenoNodesize = 12, definePhenotype = "Marketable", PhenoNodelabel = "Maxifort")
```
