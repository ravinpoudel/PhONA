...
#' @param phyobj A phyloseq object which combined OTU count, taxonomy and metadata
#' @param coloredby Select a taxonomic rank for coloring nodes in the network diagram. Possible option: "Kingdom","Phylum","Class","Order","Family","Genus","Species"
#' @return phyobj2 An updated phyloseq object with color information
#' @export
